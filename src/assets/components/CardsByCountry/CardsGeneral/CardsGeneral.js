...
const CardsGeneral = () => {
  return (
    <section 
      id="casesByCountry" className="align-items-start">
      <div 
        className="container d-flex justify-content-start flex-wrap">
        <div 
          className="d-flex justify-content-start flex-wrap" style={{margin: '30px 0px', flex: '1'}}>
          <CasesBrazil />
          <CasesChina />
          <CasesItaly />
          <CasesUS />
        ...
        <div 
          className="d-flex justify-content-start flex-wrap" style={{margin: '30px 0px'}}>
          <CasesByUF />
        </div>
      </div>
    </section>
